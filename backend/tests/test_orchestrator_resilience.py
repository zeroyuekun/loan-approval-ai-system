...
class TestStepTimeoutBudgets:
    def test_all_known_steps_have_budgets(self):
        known_steps = [
            'ml_prediction', 'email_generation', 'bias_check',
            'ai_email_review', 'email_delivery', 'next_best_offers',
            'marketing_message_generation', 'marketing_email_generation',
            'marketing_bias_check', 'marketing_ai_review', 'marketing_email_delivery',
        ]
