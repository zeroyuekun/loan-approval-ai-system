...
SAMPLE_TRANSACTIONS = [
    ...
    {'description': 'PAYROLL - ACME CORP', 'amount': 5200.00, 'date': '2025-12-31', 'balance': 8200.00, 'counterparty': 'ACME Corp', 'type': 'credit'},
    {'description': 'PAYROLL - ACME CORP', 'amount': 5200.00, 'date': '2025-11-30', 'balance': 6100.00, 'counterparty': 'ACME Corp', 'type': 'credit'},
    {'description': 'DIVIDEND - VANGUARD', 'amount': 120.00, 'date': '2025-12-15', 'balance': 4200.00, 'counterparty': 'Vanguard', 'type': 'credit'},
    # Rent
    {'description': 'RENT - 42 SMITH ST', 'amount': -1800.00, 'date': '2025-12-01', 'balance': 3000.00, 'counterparty': 'Ray White Real Estate', 'type': 'debit'},
    {'description': 'RENT - 42 SMITH ST', 'amount': -1800.00, 'date': '2025-11-01', 'balance': 2800.00, 'counterparty': 'Ray White Real Estate', 'type': 'debit'},
    # Utilities
    {'description': 'AGL ENERGY', 'amount': -180.00, 'date': '2025-12-10', 'balance': 4020.00, 'counterparty': 'AGL', 'type': 'debit'},
    {'description': 'TELSTRA MOBILE', 'amount': -89.00, 'date': '2025-11-15', 'balance': 3900.00, 'counterparty': 'Telstra', 'type': 'debit'},
    # Subscriptions
    {'description': 'NETFLIX.COM', 'amount': -22.99, 'date': '2025-12-05', 'balance': 4100.00, 'counterparty': 'Netflix', 'type': 'debit'},
    {'description': 'SPOTIFY', 'amount': -12.99, 'date': '2025-12-05', 'balance': 4077.01, 'counterparty': 'Spotify', 'type': 'debit'},
    # Essential spending
    {'description': 'WOOLWORTHS 1234', 'amount': -210.00, 'date': '2025-12-08', 'balance': 3867.01, 'counterparty': 'Woolworths', 'type': 'debit'},
    {'description': 'COLES EXPRESS', 'amount': -65.00, 'date': '2025-12-12', 'balance': 3802.01, 'counterparty': 'Coles', 'type': 'debit'},
    # Other spending
    {'description': 'JB HI-FI ONLINE', 'amount': -450.00, 'date': '2025-12-20', 'balance': 3352.01, 'counterparty': 'JB Hi-Fi', 'type': 'debit'},
    # Low balance day
    {'description': 'TRANSFER OUT', 'amount': -3000.00, 'date': '2025-12-28', 'balance': -150.00, 'counterparty': '', 'type': 'debit'},
    # Bounced payment
    {'description': 'DISHONOUR FEE - DD RETURN', 'amount': -15.00, 'date': '2025-12-29', 'balance': -165.00, 'counterparty': '', 'type': 'debit'},
]
...
class TestOpenBankingProfileFields:
    def test_has_all_expected_fields(self):
        expected_fields = {
            ...
            'min_balance_30d', 'days_negative_balance_90d', 'avg_monthly_savings_rate',
            'salary_credit_regularity', 'num_dishonours_12m', 'days_in_overdraft_12m',
            'raw_transactions',
        }
...
class TestGetBankingProfileFallback:
    ...
    def test_returns_none_when_both_fail(self):
        svc = OpenBankingService()
        with patch.object(svc, '_fetch_adatree_data', return_value=None), \
...
class TestFeatureBoundsCompliance:
    ...
    def test_extreme_transactions_within_bounds(self):
        ...
        extreme = [
            {'description': 'SALARY', 'amount': 999999, 'date': '2025-12-01', 'balance': 999999, 'counterparty': f'Source{i}', 'type': 'credit'}
