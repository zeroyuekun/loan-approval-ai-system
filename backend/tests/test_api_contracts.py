...
class TestLoanApplicationContracts:
    ...
    DETAIL_REQUIRED_KEYS = {
        'id', 'loan_amount', 'annual_income', 'credit_score', 'purpose',
        'status', 'applicant', 'decision', 'created_at', 'updated_at',
    }
...
class TestMLMetricsContracts:
    ...
    REQUIRED_KEYS = {
        'id', 'algorithm', 'version', 'accuracy', 'precision',
        'recall', 'f1_score', 'auc_roc', 'is_active', 'created_at',
        'confusion_matrix', 'feature_importances', 'roc_curve_data',
        'training_params',
    }
    ...
    def test_metrics_nullable_fields(self, auth_admin_client, active_model):
        ...
        nullable_keys = [
            'brier_score', 'gini_coefficient', 'ks_statistic', 'log_loss',
            'ece', 'optimal_threshold',
        ]
...
class TestAgentRunContracts:
    ...
    AGENTRUN_REQUIRED_KEYS = {
        'id', 'application_id', 'status', 'steps', 'created_at',
        'updated_at', 'bias_reports', 'next_best_offers', 'marketing_emails',
    }
    ...
    def test_agent_run_bias_report_shape(self, auth_admin_client, agent_run_with_data, sample_application):
        ...
        bias_report_keys = {
            'id', 'report_type', 'bias_score', 'categories', 'analysis',
            'flagged', 'requires_human_review', 'created_at',
        }
    ...
    def test_agent_run_nbo_shape(self, auth_admin_client, agent_run_with_data, sample_application):
        ...
        nbo_keys = {
            'id', 'offers', 'analysis', 'customer_retention_score',
            'loyalty_factors', 'personalized_message', 'created_at',
        }
        for key in nbo_keys:
    ...
    def test_agent_run_marketing_email_shape(self, auth_admin_client, agent_run_with_data, sample_application):
        ...
        me_keys = {
            'id', 'subject', 'body', 'passed_guardrails',
            'guardrail_results', 'generation_time_ms', 'attempt_number', 'created_at',
        }
        for key in me_keys:
