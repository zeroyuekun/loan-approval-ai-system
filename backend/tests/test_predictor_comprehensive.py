...
class TestPredictorFeatureEngineering:
    ...
    def test_derived_features_match_trainer(self):
        ...
        for col in derived_cols:
            ...
            assert abs(pred_val - train_val) < 1e-6, (
                f"Mismatch on {col}: predictor={pred_val}, trainer={train_val}"
            )
    ...
    def test_feature_bounds_for_new_fields(self):
        ...
        new_fields = [
            ...
            'savings_balance', 'salary_credit_regularity', 'num_dishonours_12m',
            'avg_monthly_savings_rate', 'days_in_overdraft_12m',
            'rba_cash_rate', 'unemployment_rate', 'property_growth_12m',
            'consumer_confidence', 'income_verification_gap', 'document_consistency_score',
        ]
