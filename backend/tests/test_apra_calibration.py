...
REQUIRED_APRA_KEYS = {
    'npl_rate', 'arrears_30_rate', 'arrears_60_rate', 'arrears_90_rate',
    'total_arrears_rate', 'lvr_80_plus_pct', 'dti_6_plus_pct',
    'by_state', 'published_date',
}
...
class TestGetApraQuarterlyArrears:
    ...
    def test_all_rates_between_zero_and_one(self, macro_svc):
        result = macro_svc.get_apra_quarterly_arrears()
        for key in ['npl_rate', 'arrears_30_rate', 'arrears_60_rate',
                     'arrears_90_rate', 'total_arrears_rate',
                     'lvr_80_plus_pct', 'dti_6_plus_pct']:
...
class TestValidateByState:
    ...
    def test_matching_rates_all_aligned(self, validator, apra_data):
        state_outcomes = {
            state: {'default_rate': rate, 'count': 100}
            for state, rate in apra_data['by_state'].items()
        }
...
class TestRecommendations:
    ...
    def test_recommendations_include_pass_msg_when_calibrated(self, validator):
        ...
        assert any('acceptable' in r.lower() or 'no action' in r.lower()
