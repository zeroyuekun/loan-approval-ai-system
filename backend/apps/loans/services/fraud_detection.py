...
class FraudDetectionService:
    ...
    def run_checks(self, application):
        ...
        has_high_risk_failure = any(not c["passed"] and c["risk_level"] == "high" for c in checks)
    ...
    def _compute_risk_score(checks):
        ...
        failed_weight = sum(_RISK_WEIGHTS[c["risk_level"]] for c in checks if not c["passed"])
