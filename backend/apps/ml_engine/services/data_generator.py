...
class DataGenerator:
    ...
    # this invariant.
    #
    # The pure (self-free) phase helpers — bureau/CCR synthesis and ex-post
    # outcome simulation — live in the `data_generator_phases` sibling module
    # (imported as `_phases`) to keep this file under the file-size ratchet.
    # The helpers below still depend on instance state (e.g. self._underwriting)
    # or are kept here for locality.
    # ------------------------------------------------------------------
    ...
    def generate(self, num_records=50000, random_seed=42, label_noise_rate=0.05):
        ...
        _bureau = _phases.synthesize_bureau_features(n, credit_norm, age_proxy, annual_income, has_bankruptcy, rng)
        ...
        # CCR features
        # =============================================================
        _ccr = _phases.synthesize_ccr_features(n, credit_norm, annual_income, num_defaults_5yr, rng)
