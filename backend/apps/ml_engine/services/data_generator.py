...
class DataGenerator:
    ...
    SUB_POPULATIONS = {
        "first_home_buyer": {
            "weight": 0.15,
            "age_mean": 33,
            "age_std": 5,  # ABS Dec 2025: avg FHB age 33
            ...
            "loan_mult_std": 0.8,
            "lvr_mean": 0.87,
            "lvr_std": 0.05,  # high LVR — APRA: 30.4% of new loans LVR>=80%
        ...
        "upgrader": {
            ...
            "loan_mult_std": 0.8,
            "lvr_mean": 0.65,
            "lvr_std": 0.12,  # moderate LVR (existing equity)
            "purpose_override": "home",
        },
        "refinancer": {
            "weight": 0.10,
            ...
            "loan_mult_std": 0.7,
            "lvr_mean": 0.55,
            "lvr_std": 0.12,  # low LVR (long payment history)
            "purpose_override": "home",
        },
        "personal_borrower": {
            "weight": 0.35,
        ...
        "investor": {
            ...
            "loan_mult_std": 1.0,
            "lvr_mean": 0.70,
            "lvr_std": 0.08,  # lower LVR than owner-occ
            "purpose_override": "home",
        },
    }
