...
DEMO_CUSTOMERS = [
    ...
    {
        "username": "chris_dimitriou",
        "first_name": "Chris",
        "last_name": "Dimitriou",
        "email": "chris.dimitriou@example.com",
    },
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        if use_live_data:
            ...
            self.stdout.write(self.style.SUCCESS(f"Calibration snapshot assembled at {benchmarks['fetched_at']}"))
        ...
        if db_count > 0:
            ...
            self.stdout.write(self.style.SUCCESS(f"Created/updated {len(customers)} demo customers with full profiles"))
            ...
            for idx, (_, row) in enumerate(subset.iterrows()):
                ...
                LoanApplication.objects.create(
                    ...
                    if not (isinstance(row["property_value"], float) and math.isnan(row["property_value"]))
                    and row["property_value"] > 0
                    else None,
                    deposit_amount=row["deposit_amount"]
                    if not (isinstance(row["deposit_amount"], float) and math.isnan(row["deposit_amount"]))
                    and row["deposit_amount"] > 0
                    else None,
                    monthly_expenses=row["monthly_expenses"]
                    if not (isinstance(row["monthly_expenses"], float) and math.isnan(row["monthly_expenses"]))
                    else None,
                    existing_credit_card_limit=row["existing_credit_card_limit"]
                    if not (
                        isinstance(row["existing_credit_card_limit"], float)
                        and math.isnan(row["existing_credit_card_limit"])
                    )
                    else 0,
            ...
            self.stdout.write(
                self.style.SUCCESS(f"Created {created_count} LoanApplication records across {len(customers)} customers")
            )
            ...
            demo_scenarios = [
                {
                    ...
                    "username": "sarah_chen",
                    "annual_income": Decimal("152000.00"),
                    "credit_score": 810,
                    "loan_amount": Decimal("680000.00"),
                    "loan_term_months": 360,
                    "debt_to_income": Decimal("4.70"),
                    "employment_length": 6,
                    "purpose": "home",
                    "home_ownership": "rent",
                    "has_cosigner": False,
                    "property_value": Decimal("850000.00"),
                    "deposit_amount": Decimal("170000.00"),
                    "monthly_expenses": Decimal("3400.00"),
                    ...
                    "num_bnpl_accounts": 0,
                    "savings_balance": Decimal("45000.00"),
                    "salary_credit_regularity": 0.98,
                    "num_dishonours_12m": 0,
                    "avg_monthly_savings_rate": 0.15,
                    "days_in_overdraft_12m": 0,
                    "rba_cash_rate": 4.35,
                    "unemployment_rate": 4.1,
                    "property_growth_12m": 5.2,
                    "consumer_confidence": 82.5,
                    "income_verification_gap": 0.02,
                    "document_consistency_score": 0.97,
                },
                {
                    "label": "Regional Upgrader (Approved)",
                    "username": "liam_oconnor",
                    "annual_income": Decimal("185000.00"),
                    "credit_score": 890,
                    "loan_amount": Decimal("520000.00"),
                    "loan_term_months": 300,
                    "debt_to_income": Decimal("3.10"),
                    "employment_length": 12,
                    "purpose": "home",
                    "home_ownership": "mortgage",
                    "has_cosigner": False,
                    "property_value": Decimal("780000.00"),
                    "deposit_amount": Decimal("260000.00"),
                    "monthly_expenses": Decimal("3800.00"),
                    ...
                    "state": "QLD",
                    "is_existing_customer": True,
                    "num_credit_enquiries_6m": 0,
                    "worst_arrears_months": 0,
                    "num_defaults_5yr": 0,
                    "credit_history_months": 180,
                    "total_open_accounts": 5,
                    "num_bnpl_accounts": 0,
                    "savings_balance": Decimal("95000.00"),
                    "salary_credit_regularity": 1.0,
                    "num_dishonours_12m": 0,
                    "avg_monthly_savings_rate": 0.22,
                    "days_in_overdraft_12m": 0,
                    "rba_cash_rate": 4.35,
                    "unemployment_rate": 4.1,
                    "property_growth_12m": 3.8,
                    "consumer_confidence": 82.5,
                    "income_verification_gap": 0.01,
                    "document_consistency_score": 0.99,
                },
                {
                    "label": "Self-Employed Tradie (Borderline)",
                    "username": "marco_rossi",
                    "annual_income": Decimal("135000.00"),
                    "credit_score": 760,
                    "loan_amount": Decimal("620000.00"),
                    "loan_term_months": 360,
                    "debt_to_income": Decimal("4.90"),
                    "employment_length": 5,
                    "purpose": "home",
                    "home_ownership": "rent",
                    "has_cosigner": False,
                    "property_value": Decimal("775000.00"),
                    "deposit_amount": Decimal("155000.00"),
                    ...
                    "num_bnpl_accounts": 1,
                    "savings_balance": Decimal("28000.00"),
                    "salary_credit_regularity": 0.75,
                    "num_dishonours_12m": 0,
                    "avg_monthly_savings_rate": 0.08,
                    "days_in_overdraft_12m": 5,
                    "rba_cash_rate": 4.35,
                    "unemployment_rate": 4.1,
                    "property_growth_12m": 4.5,
                    "consumer_confidence": 82.5,
                    "income_verification_gap": 0.12,
                ...
                },
                {
                    ...
                    "total_open_accounts": 2,
                    "num_bnpl_accounts": 2,
                    "savings_balance": Decimal("3500.00"),
                    "salary_credit_regularity": 0.55,
                    "num_dishonours_12m": 1,
                    "avg_monthly_savings_rate": 0.03,
                    "days_in_overdraft_12m": 12,
                    "rba_cash_rate": 4.35,
                    "unemployment_rate": 4.1,
                    "property_growth_12m": 4.5,
                    "consumer_confidence": 82.5,
                    "income_verification_gap": 0.08,
                    "document_consistency_score": 0.91,
                },
                {
                    "label": "High-DTI Investor (Denied - APRA cap)",
                    "username": "raj_patel",
                    "annual_income": Decimal("210000.00"),
                    "credit_score": 850,
                    "loan_amount": Decimal("1300000.00"),
                    "loan_term_months": 360,
                    "debt_to_income": Decimal("6.20"),
                    "employment_length": 15,
                    "purpose": "home",
                    "home_ownership": "mortgage",
                    "has_cosigner": False,
                    "property_value": Decimal("1625000.00"),
                    "deposit_amount": Decimal("325000.00"),
                    "monthly_expenses": Decimal("4500.00"),
                    "existing_credit_card_limit": Decimal("25000.00"),
                    ...
                    "state": "NSW",
                    "is_existing_customer": True,
                    "num_credit_enquiries_6m": 4,
                    "worst_arrears_months": 0,
                    "num_defaults_5yr": 0,
                    "credit_history_months": 210,
                    "total_open_accounts": 8,
                    "num_bnpl_accounts": 0,
                    "savings_balance": Decimal("120000.00"),
                    "salary_credit_regularity": 1.0,
                    "num_dishonours_12m": 0,
                    "avg_monthly_savings_rate": 0.18,
                    "days_in_overdraft_12m": 0,
                    "rba_cash_rate": 4.35,
                    "unemployment_rate": 4.1,
                    "property_growth_12m": 5.2,
                    "consumer_confidence": 82.5,
                    "income_verification_gap": 0.01,
                    "document_consistency_score": 0.98,
                },
                {
                    ...
                    "existing_credit_card_limit": Decimal("0.00"),
                    "number_of_dependants": 1,
                    "employment_type": "payg_permanent",
                    "applicant_type": "single",
                    "has_hecs": False,
                    ...
                    "state": "SA",
                    "is_existing_customer": False,
                    "num_credit_enquiries_6m": 5,
                    "worst_arrears_months": 3,
                    "num_defaults_5yr": 2,
                    "credit_history_months": 48,
                    "total_open_accounts": 1,
                    "num_bnpl_accounts": 0,
                    "savings_balance": Decimal("2000.00"),
                    "salary_credit_regularity": 0.85,
                    "num_dishonours_12m": 2,
                    "avg_monthly_savings_rate": 0.02,
                    "days_in_overdraft_12m": 30,
                    "rba_cash_rate": 4.35,
                    "unemployment_rate": 4.1,
                    "property_growth_12m": 4.5,
                    "consumer_confidence": 82.5,
                    "income_verification_gap": 0.05,
                    "document_consistency_score": 0.82,
                },
            ]
