...
class AddressService:
    ...
    def validate_address(self, address: str, suburb: str, state: str, postcode: str) -> AddressValidation:
        ...
        result = self._validate_via_google(f"{address}, {suburb} {state_upper} {postcode_clean}, Australia")
        if result is not None:
            return result
    ...
    def _validate_via_gnaf(self, address: str, suburb: str, state: str, postcode: str) -> AddressValidation | None:
    ...
    def _validate_via_google(self, full_address: str) -> AddressValidation | None:
