...
class GeneratedEmail(models.Model):
    ...
    application = models.ForeignKey("loans.LoanApplication", on_delete=models.CASCADE, related_name="emails")
    ...
    template_fallback = models.BooleanField(
...
class GuardrailLog(models.Model):
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
    email = models.ForeignKey(GeneratedEmail, on_delete=models.CASCADE, related_name="guardrail_checks")
