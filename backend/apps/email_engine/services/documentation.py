...
def build_documentation_checklist(application) -> str:
    ...
    docs.append(
        "Proof of current residential address (utility bill, council rates notice, or bank statement dated within the last 3 months)"
    )
    ...
    if purpose == "home":
        ...
        docs.append(
            "Evidence of genuine savings (savings account statements showing at least 3 months of regular deposits)"
        )
