...
| 8 | Cross-border disclosure | Partial | No committed hosting target today; self-hosters are encouraged to pin to an AU region (Sydney) to minimise transfer | Any third-party call (Claude API, credit-bureau stub) crosses borders; documented but no contractual clause list yet |
